...
:check_firewall
  ...
  set /p=Check firewall -- <nul
  (C:\Windows\System32\netsh.exe Advfirewall show allprofiles) && (@echo  >OK & C:\Windows\System32\findstr.exe /a:A . OK*&del OK) || (@echo  >ERROR & C:\Windows\System32\findstr.exe /a:C . ERROR*&del ERROR)
:eof
